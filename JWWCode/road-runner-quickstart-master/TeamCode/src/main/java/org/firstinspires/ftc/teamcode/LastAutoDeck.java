...
//    public double clawTopPosition;
//    public double shoulderLeftPosition;
//    public double shoulderRightPosition;
//    public double clawBottomPosition;
...
//    public double wristRightPosition = 0.0978;
    ...
    public void runOpMode() {
        ...
        waitForStart(); // Ensures that the match has started before running the thread

        if (opModeIsActive()) {
            new Thread(() -> {
                while (opModeIsActive()) { // Ensure the thread only runs while the op mode is active
