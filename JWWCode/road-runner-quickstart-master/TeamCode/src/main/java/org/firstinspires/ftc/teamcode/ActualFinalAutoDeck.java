...
// Paste slides and arms actioned code here
    ...
    public void runOpMode() {
        Pose2d initialPose = new Pose2d(16.00, -63.00, Math.toRadians(90.00));
        ...
        TrajectoryActionBuilder goToRungs = drive.actionBuilder()
        ...
        TrajectoryActionBuilder goToDeck = drive.actionBuilder(new Pose2d(63.24, -26.73, Math.toRadians(0.00)))
                .strafeToSplineHeading(new Pose2d(57.10, -56.72, Math.toRadians(-90.00)));
