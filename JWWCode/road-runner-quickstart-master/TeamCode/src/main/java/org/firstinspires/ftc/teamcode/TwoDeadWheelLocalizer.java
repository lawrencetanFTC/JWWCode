...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1345.8767186317675; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 1.7224663811083258; // x position of the perpendicular encoder (in tick units)
    }
